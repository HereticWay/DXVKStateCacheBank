...
public class SampleDataCreator {
    ...
    public SampleDataCreator(UserRepository userRepository, GameRepository gameRepository, CacheFileService cacheFileService) throws IOException, NoNewCacheEntryException, SQLException, UnsuccessfulCacheMergeException {
