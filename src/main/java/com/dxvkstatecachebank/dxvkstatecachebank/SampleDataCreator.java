...
public class SampleDataCreator {
    ...
    public SampleDataCreator(UserRepository userRepository, GameRepository gameRepository, CacheFileRepository cacheFileRepository) {
    ...
    public void insertGames() {
        gameRepository.save(
                ...
                .incrementalCache(BlobProxy.generateProxy(new byte[] {0x10, 0x34, 0x7A, 0x55}))
                .steamId(1172470L)
                .build()
        );
        ...
        gameRepository.save(
                ...
                .incrementalCache(BlobProxy.generateProxy(new byte[] {0x22, 0x49, 0x11, 0x05}))
                .build()
        );
    }
